  ...
  beerfeature: {
    ...
    elements: {
      /* Grounded to the Pragmatic Pils reference poster, 2026-07-31:
         giant wordmark bleeding the top edge, BREWING spaced below,
         patterned field, centered can, brand shape cutting into the
         beer foam band that carries headline + subheadline. */
      wordmark:    { kind: 'asset', cx: 900, y: -44, w: 1724 },
      brewing:     { kind: 'sub',  x: 900, y: 468, anchor: 'middle', size: 92, track: 0.42 },
